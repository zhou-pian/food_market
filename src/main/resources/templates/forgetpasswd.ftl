...
<div class="main">
    <div class="login-form fr">
        ...
        <div class="form-bd">
            <form action="/userLogin/updatePassword" method="post" onsubmit="return check() ">
                <input type="text" style="display: none" value="${user_name}" id="userName" name="userName"/>
                <input type="text" style="display: none" value="${user_password}" id="userOldPassword" name="userOldPassword"/>
                <input type="text" style="display: none" value="${user_phone}" id="userPhone" name="userPhone"/>
                <dl>
                    <dt>新密码</dt>
                ...
                <dl>
                    <dt>&nbsp;</dt>
                    <dd>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="submit" value="立即修改" class="submit"/> </dd>
                </dl>
            </form>
...
<script>
    ...
    function check() {
        ...
        var userOldPassword = document.getElementById("userOldPassword").value.trim();
        var userPhone = document.getElementById("userPhone").value.trim();
        $.ajax({
            url: "/userLogin/CheckPassword1",
            type: "post",
            data: {
                "code": code,
                "password": password,
